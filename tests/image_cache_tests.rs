...
fn test_image_caching_lifecycle() {
    ...
    let result = render_board_png(&board, false);
    ...
    let result_cached = render_board_png(&board, false);
    ...
    assert_eq!(
        ...
        "Cache file was modified, meaning it was likely regenerated instead of used"
    );
    ...
    assert_eq!(
        bytes_original, bytes_cached,
        "Cached bytes differ from generated bytes"
    );
